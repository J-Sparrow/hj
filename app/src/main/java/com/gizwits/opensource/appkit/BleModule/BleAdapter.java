...
public class BleAdapter extends ArrayAdapter<BleDeviceEntity> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.name =(TextView) convertView.findViewById(R.id.ble_name);
            viewHolder.mac = (TextView) convertView.findViewById(R.id.ble_macId);
            viewHolder.rssi =(TextView) convertView.findViewById(R.id.ble_rssi);
            viewHolder.imageView = (ImageView) convertView.findViewById(R.id.ble_rssi_image);
